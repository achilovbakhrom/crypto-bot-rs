    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ScheduledTransaction::ScheduledFor).timestamp_with_time_zone().not_null())
                ...
                .col(ColumnDef::new(ScheduledTransaction::ExecutedAt).timestamp_with_time_zone().null())
